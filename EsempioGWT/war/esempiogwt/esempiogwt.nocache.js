...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "esempiogwt" because\n';
  ...
  $wnd.__gwt_activeModules['esempiogwt'] = {
    'moduleName' : 'esempiogwt',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/esempiogwt.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['esempiogwt'].superdevmode = true;

  var expectedSuffix = '/esempiogwt.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + esempiogwt + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:esempiogwt';
  var devModeSessionKey = '__gwtDevModeSession:esempiogwt';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/esempiogwt/esempiogwt.nocache.js';
  ...
  $wnd.__gwt_activeModules['esempiogwt'].canRedirect = true;
  $wnd.__gwt_activeModules['esempiogwt'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/esempiogwt?user.agent=' + ua + '&_callback=' + callback;
